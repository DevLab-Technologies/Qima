...
class WatchlistStore {
  ...
  Future<List<Record<WatchCard>>> exportRecords() => _store.exportRecords();

  /// Restores a previously-exported record set — see
  /// `SyncedStore.importRecords` for the merge/replace semantics.
  Future<List<WatchCard>> importRecords(List<Record<WatchCard>> records, {required bool replace, DateTime? now}) =>
